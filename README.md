# SkyHawk Recovery Project for the Samsung Galaxy J7 Nxt
...
# Clone my local repo
$ git clone https://github.com/samsungexynos7870/android_manifest_samsung_j7velte.git -b skyhawk .repo/local_manifests
